...
func makeArgsString() map[string]ConfigureOptionValue {
	...
	argsString["sbin-path"] = ConfigureOptionValue{
		Name: "--sbin-path",
		Desc: "set nginx binary pathname",
	}
	argsString["modules-path"] = ConfigureOptionValue{
		Name: "--modules-path",
